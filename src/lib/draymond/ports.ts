...
export const TOOL_PORTS: ToolPort[] = [
  ...
  { slug: 'tap919-middleman', name: 'Tap919 Middleman', category: 'service', port: 4200, env: 'TAP919_URL', health: '/health', notes: 'Metered agent-to-agent gateway (folded into litellm pipeline). Scaffolding-only checkout — no runnable server yet.' },
