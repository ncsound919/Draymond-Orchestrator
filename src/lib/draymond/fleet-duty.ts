...
export const FLEET_DUTY: DutyAssignment[] = [
  ...
  { agentId: 'depscan', duty: 'always-on', cron: '0 5 * * 1' },
  { agentId: 'nuclei-scanner', duty: 'always-on', cron: '0 5 * * 1' },
  { agentId: 'litellm', duty: 'always-on', cron: '*/15 * * * *' },
  { agentId: 'deterministic-brain', duty: 'always-on', cron: '*/5 * * * *' },
  { agentId: 'phoenix', duty: 'always-on', cron: '0 6 * * *' },
  { agentId: 'generative-video-ai', duty: 'always-on', cron: '0 10 * * *' },
