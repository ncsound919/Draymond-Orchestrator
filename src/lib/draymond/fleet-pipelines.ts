...
export const FLEET_PIPELINES: FleetPipeline[] = [
  {
    ...
    purpose: 'Voice-check → calendar → format audit → engagement tracking. The Draymond-led marketing formation production cell (SMD decommissioned 2026-09-24).',
    stages: [
      {
        ...
        command: 'node',
        args: ['node_modules/tsx/dist/cli.mjs', path.join('..', '01_Platforms', 'Overlay365', 'agent-team', 'agents', 'marketing', 'index.ts'), 'voice'],
      },
      {
        ...
        kind: 'cli',
        command: 'node',
        args: ['node_modules/tsx/dist/cli.mjs', path.join('..', '01_Platforms', 'Overlay365', 'agent-team', 'agents', 'marketing', 'index.ts'), 'schedule'],
      },
      {
        ...
        kind: 'cli',
        command: 'node',
        args: ['node_modules/tsx/dist/cli.mjs', path.join('..', '01_Platforms', 'Overlay365', 'agent-team', 'agents', 'marketing', 'index.ts'), 'format'],
      },
      {
        ...
        kind: 'cli',
        command: 'node',
        args: ['node_modules/tsx/dist/cli.mjs', path.join('..', '01_Platforms', 'Overlay365', 'agent-team', 'agents', 'marketing', 'index.ts'), 'track'],
      },
    ],
  },
  {
