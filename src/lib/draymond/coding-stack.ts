...
export const CODING_STACK: CodingLayer[] = [
  {
    ...
    primary: 'uplift-agent',
    fallback: 'megacode',
    tools: ['uplift-agent', 'megacode', 'everything-claude-code', 'sub-team'],
    description: 'Write and edit code. Uplift Agent (Hermes fork) is the deepest coding agent; Megacode handles multi-LLM/JetBrains work; Everything Claude Code owns agent/CLI/skill authoring; Sub-Team runs deterministic spec-to-implementation pipelines.',
  },
  {
    id: 'refactor',
  ...
  },
  {
    ...
    primary: 'reporank',
    fallback: 'grader',
    tools: ['reporank', 'grader', 'big-homie'],
    description: 'Score and audit a repo: RepoRank for depth + remediation plans, Grader for the data-backed grade, Big Homie for the merge quality gate.',
  },
  {
    id: 'security',
